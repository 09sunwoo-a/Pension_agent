...
r3 = ask("이 고객 평가금액 얼마야?", customer_id="198734-1205842", session_id="branch-101-2026-08-20")
```
...
$CA "이 고객 투자성향 뭐야?" -c 198734-1205842
...
$CA -c 198734-1205842 "이 고객 투자성향 뭐야?" "그럼 최근 3개월 수익률은?"
...
지식 질의응답과 화법 코칭은 고객 화면 없이도 답한다. customer_id 는 KB-PIN 이다 —
목록은 `../strategy_agent/customer.py`의 `PERSONAS` 참고(예: 이준호=`198734-1205842`).
