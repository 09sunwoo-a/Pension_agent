...
> **일정 이동:** 시연일보다 먼저 끝나는 일정이 생겨 2026-09-16 에 9건 전부 8주(56일) 뒤로 옮겼다(요일은 그대로). `src/pension_agent/strategy_agent/data/assets.json` · `outreach_golden.json` 이 같은 값을 갖는다
...
- `organizer`: `KB스타뱅킹`
- `schedule`: `2026-11-16 ~ 2027-01-08`
